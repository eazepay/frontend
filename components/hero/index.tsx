...
export default function Hero() {
  return (
    <div
      className="w-screen h-screen text-[#532775] mb-[70px] bg-white"
      // style={{
    ...
    >
      <div className="container mx-auto flex px-5 py-10 lg:pt-[150px] lg:pb-[30px] items-center justify-center md:flex-row-reverse flex-col-reverse">
        <Image
          className="lg:w-2/6 md:w-3/6 w-full object-cover object-center mb-[80px]  md:mt-[68px]"
          alt="hero"
          src={hero}
        />
        <div className="text-left lg:w-6/12 w-full">
          ...
          <p className="text-2xl mb-8">
            Pay for goods and services in any local currency using USSD, powered
            by blockchain technology.
          </p>
          <div className="flex justify-left mx-auto">
            <button className="bg-[#532775] text-white font-bold rounded-full  py-4 px-8">
